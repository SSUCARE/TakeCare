...
// 두번째 탭의 피보호자 모드
public class CaredShareFragment extends Fragment implements View.OnClickListener {
    ...
    public CaredShareFragment(List<String> UserName, List<Integer> UserId){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_share_cared,container, false);
